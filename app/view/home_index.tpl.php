    ...
    <div class="login-container">
        ...
        <div class="form-box">
            <form action="<?php echo APP_URL; ?>login" method="post">
                <input name="form[user]" type="text" placeholder="E-mail" style="border-radius: 5px 5px 0 0">
                <input name="form[password]" type="password" placeholder="Password" style="border-radius: 0 0 5px 5px;">
