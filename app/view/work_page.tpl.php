...
?>
    <main class="container track_bg">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12- col-xs-12 calendar_form">
                <div class="col-md-5 col-xs-5" id='calendar'></div>
                <div class="col-md-5 col-xs-5 col-md-offset-1 form_style">
            ...
            <div class="col-lg-12 col-md-12- col-xs-12 work_col">
